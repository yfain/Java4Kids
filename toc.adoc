...
*  <<Chapter_7.adoc#,Chapter 7. Exceptions: Dealing with Errors (work in progress)>>
*  <<Chapter_8.adoc#,Chapter 8. Introduction to GUI with JavaFX>>
* <<Chapter_9.adoc#,Chapter 9. User Interaction in JavaFX (work in progress)>> 
