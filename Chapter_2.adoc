...
TIP: To become a real pro in IDEA, you should use the _hotkeys_, which are combinations of key-presses on the keyboard. With hotkeys you'll be able to navigate in your IDEA projects a lot faster than by clicking through menus. You can find the link to the document listing IDEA's hotkeys in the section Additional Reading at the end of this chapter.
