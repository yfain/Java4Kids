...
if [ "$1" = "html" ]; then
    ...
    adoc_files=(./Chapter_1.adoc ./Chapter_2.adoc ./Chapter_3.adoc ./Chapter_4.adoc ./Chapter_5.adoc ./Chapter_6.adoc  ./Chapter_7.adoc ./Chapter_8.adoc ./Chapter_9.adoc ./Chapter_10.adoc)
