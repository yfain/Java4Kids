...
* You can add `implements Runnable` to the declaration of a class and implement the method `run`, which, again, should contain the code to be executed in parralel. 
